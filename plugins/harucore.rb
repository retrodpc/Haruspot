...
class Cinch::Harucore
  ...
  match /ping/, :method => :on_ping, :react_on => [:channel, :private]
  match /violin/, :method => :on_violin, :react_on => [:channel, :private]
  match /aaa/, :method => :on_aaa, :react_on => [:channel, :private]
